...
export default function App() {
  ...
  const navItems = [
    ...
    { name: 'Sources', path: '/sources', icon: Icons.Sources },
  ...
  const renderPage = () => {
    ...
    if (currentPath === '/sources') return <DataSources />;
    if (currentPath === '/data') return <DataExplorer />;
